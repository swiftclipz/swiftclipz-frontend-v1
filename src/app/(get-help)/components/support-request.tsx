...
const SupportRequest = () => {
  return (
    <div className="px-8 xl:px-24 pt-20 pb-32">
      ...
      <p className="text-customBlack00 text-lg lg:text-xl mb-10">
        ...
        dedicated to resolving your concerns promptly. Submit a support ticket,
        and we&apos;ll address your query swiftly. Our goal is to respond to all
        requests within 24 hours, ensuring a seamless Swiftclipz experience for
        you.
      </p>
      <SupportForm />
    </div>
